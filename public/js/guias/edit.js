...
$(document).ready(function () {
    var profissional_anterior, plano_anterior;

    $('#guia_id').text(getParameterByName('guia_id'));
    ...
    var orcamento = getParameterByName('orcamento');

    if(orcamento != ""){
        $('#orcamento').val(orcamento).trigger('change');
    }
    ...
    var tabela_procedimentos_guia = $('#tabela-procedimentos-guia').DataTable({
        ...
        ajax: {
            ...
            dataType: 'JSON',
            data: function (d) {
                d.guia_id = getParameterByName('guia_id');
            },
            error: function(d){
                console.log(d);
            }
    ...
    $('#btnEnviar').on('click', function(e) {
        ...
        Swal({
            ...
            if(result.value){
                $.ajax({
                    url: '/vida/guias/' + getParameterByName('guia_id'),
                    type: 'PUT',
                    dataType: 'JSON',
                    data: {
                        guia_id: getParameterByName('guia_id'),
