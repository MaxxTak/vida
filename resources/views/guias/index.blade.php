...
@section('page-header')
    Emissão de Guias <small>{{ trans('app.manage') }}</small>
@endsection
...
@push('scripts')
    ...
    <script type="text/javascript" src="{!! asset('/js/guias/index.js') !!}"></script>
    ...
    {{-- <script type="text/javascript" src="{!! asset('/js/qz-tray/rsvp-3.1.0.min.js') !!}"></script>
    <script type="text/javascript" src="{!! asset('/js/qz-tray/sha-256.min.js') !!}"></script>
    <script type="text/javascript" src="{!! asset('/js/qz-tray/qz-tray.js') !!}"></script> --}}
@endpush