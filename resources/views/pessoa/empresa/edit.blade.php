...
@section('page-header')
    Editar {{$empresa->name}} <small>Clique na abas para inserir as informações</small>
@stop
    ...
    <div class="row mB-40">
        <div class="col-sm-8">
            <div class="bgc-white p-20 bd">
                ...
                <form method="POST" action="/vida/put/pessoa/{{$empresa->id}}">
                    {{ csrf_field() }}
                    ...
                    <div id="Pessoal" class="tabcontent">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <input id="name" type="text" class="form-control" name="name" value="{{ $empresa->name }}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nome_fantasia') ? ' has-error' : '' }}">
                            ...
                            <input id="nome_fantasia" type="text" class="form-control" name="nome_fantasia" value="{{ $empresa->empresa->razao_social }}" >
                        ...
                        <div class="form-group{{ $errors->has('documento') ? ' has-error' : '' }}">
                            ...
                            <input id="documento" type="documento" class="form-control" name="documento" value="{{ $empresa->cnpjcpf }}" >
                        ...
                        <div class="form-group{{ $errors->has('end_eletronico') ? ' has-error' : '' }}">
                            ...
                            <input id="end_eletronico" type="end_eletronico" class="form-control" name="end_eletronico" value="{{ $empresa->email }}" >
                        ...
                        <div class="form-group{{ $errors->has('ramo_atividade') ? ' has-error' : '' }}">
                            ...
                            <input id="ramo_atividade" type="text" class="form-control" name="ramo_atividade" value="{{ $empresa->empresa->ramo_atividade }}">
                    ...
                    <div id="Endereco" class="tabcontent">
                        ...
                        <div class="form-group{{ $errors->has('cep') ? ' has-error' : '' }}">
                            ...
                            <input id="cep" type="text" class="form-control" name="cep" value="{{ $empresa->endereco->cep }}" >
                        ...
                        <div class="form-group{{ $errors->has('endereco') ? ' has-error' : '' }}">
                            ...
                            <input id="endereco" type="text" class="form-control" name="endereco" value="{{ $empresa->endereco->endereco  }}" >
                        ...
                        <div class="form-group{{ $errors->has('numero') ? ' has-error' : '' }}">
                            ...
                            <input id="numero" type="text" class="form-control" name="numero" value="{{ $empresa->endereco->numero }}" >
                        ...
                        <div class="form-group{{ $errors->has('complemento') ? ' has-error' : '' }}">
                            ...
                            <input id="complemento" type="text" class="form-control" name="complemento" value="{{ $empresa->endereco->complemento }}">
                        ...
                        <div class="form-group{{ $errors->has('bairro') ? ' has-error' : '' }}">
                            ...
                            <input id="bairro" type="text" class="form-control" name="bairro" value="{{ $empresa->endereco->bairro }}" >
                        ...
                        <div class="form-group{{ $errors->has('cidade') ? ' has-error' : '' }}">
                            ...
                            <input id="cidade" type="text" class="form-control" name="cidade" value="{{ $empresa->endereco->cidade }}" >
                        ...
                        <div class="form-group{{ $errors->has('uf') ? ' has-error' : '' }}">
                            ...
                            <input id="uf" type="uf" class="form-control" name="uf" value="{{ $empresa->endereco->UF }}" >
                ...
                <!--  <div id="Contato" class="tabcontent">
                    ...
                    <div id="Usuario" class="tabcontent">
                        ...
                        <div class="form-group{{ $errors->has('usu') ? ' has-error' : '' }}">
                            ...
                            <input id="usu" type="text" class="form-control" name="usu" value="{{ $empresa->username }}" >
