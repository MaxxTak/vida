    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div class="masonry-item col-md-12">
            ...
            <div class="bd bgc-white">
                <div class="layers">
                    <div class="layer w-100 p-20">
                        <h6 class="lh-1">Agendamentos</h6>
                    </div>
                    <div class="layer w-100">
                        <div class="bgc-light-blue-500 c-white p-20">
                            <div class="peers ai-c jc-sb gap-40">
                                <div class="peer peer-greed">
                                    <h5><span id="ag_data">04 Data 2019</span></h5>
                                    <p class="mB-0">Próximos Agendamentos</p>
                                </div>
                                <div class="peer">
                                    <h3 class="text-right"><span id="ag_total">540</span></h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ta-c bdT w-100 p-20">
                    <a href="/vida/agendamentos">Consultar todos agendamentos</a>
                </div>
            </div>
        </div>
