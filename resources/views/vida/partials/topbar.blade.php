        ...
        <ul class="nav-right">
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="pX-20 pY-15 bdB">
                        ...
                        <span class="fsz-sm fw-600 c-grey-900">Notificações</span>
                    </li>
                    <li>
                    ...
                    <li class="pX-20 pY-15 ta-c bdT">
                        <span>
                            <a href="" class="c-grey-600 cH-blue fsz-sm td-n"> Ver todas
            ...
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT">
                        <span>
                            <a href="" class="c-grey-600 cH-blue fsz-sm td-n">Ver todas <i class="fs-xs ti-angle-right mL-10"></i>
                            </a>
                        </span>
                    </li>
                </ul>
